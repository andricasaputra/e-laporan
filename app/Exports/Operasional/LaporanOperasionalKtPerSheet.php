...
class LaporanOperasionalKtPerSheet extends AbstractLaporanPerSheet implements FromView, WithTitle, WithEvents, ShouldAutoSize
{
    /**
    ...
    */
    ...
    {
        return view('intern.operasional.kt.download.laporan_operasional_excel')->withDatas($this->data->sentDatasToView());
    }
