...
class LaporanPemakaianDokumenKtExport implements FromView, ShouldAutoSize
{
    ...
    {
        return view('intern.operasional.kt.download.laporan_pemakaian_dokumen_excel')->withDatas($this->sentDatasToView());
    }
    ...
    {
        return $this->tableHeaderLaporanRekapitulasiKomoditiKt();
    }
