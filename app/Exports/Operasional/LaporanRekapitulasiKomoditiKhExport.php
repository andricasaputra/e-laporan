...
class LaporanRekapitulasiKomoditiKhExport implements WithMultipleSheets
{
    use Exportable;
     ...
     *
     * @var App\Repositories\Operasional\DataOperasionalKhRepository|DataOperasionalKhRepository
     */
    public $repository;
