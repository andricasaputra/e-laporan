...
class LaporanRekapitulasiKomoditiKhPerSheet extends AbstractLaporanPerSheet implements FromView, WithTitle, WithEvents
{
    /**
    ...
    */
    ...
    {
        return view('intern.operasional.kh.download.laporan_rekapitulasi_komoditi_excel')->withDatas($this->data->sentDatasToView());
    }
