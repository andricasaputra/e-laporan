...
class LaporanRekapitulasiKomoditiKtPerSheet extends AbstractLaporanPerSheet implements FromView, WithTitle, WithEvents
{
    /**
    ...
    */
    ...
    {
        return view('intern.operasional.kt.download.laporan_rekapitulasi_komoditi_excel')->withDatas($this->data->sentDatasToView());
    }
