...
class BasePembatalanDokumenController extends Controller
{
    /**
    ...
    protected function runImportProcess($model)
    {
        ...
        $imports     = $factory->initializeImportsType($model, $this->request);
        ...
        if ($imports->notificationTrigger()) {
            ...
            $this->tanggal = $imports->getTanggalLaporan();
