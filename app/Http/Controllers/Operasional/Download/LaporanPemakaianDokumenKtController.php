...
class LaporanPemakaianDokumenKtController extends DownloadController
{
     ...
     * @return Excel
     */
	public function laporanPemakaianDokumenKt()
    {
        return excel()->create("Laporan Pemakaian Dokumen {$this->monthName} Tahun {$this->year} {$this->karantina} {$this->wilkerName}", function($excel) {
                ...
                $excel->sheet('Pemakaian Dokumen Tumbuhan', function($sheet){

                    /*init page view/ source page laporan*/ 
                    $sheet->loadView('intern.operasional.kt.download.laporan_pemakaian_dokumen_excel')
