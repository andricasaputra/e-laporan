...
class UploadController extends BaseOperasionalController
{
    ...
    public function __construct(Model $model, Request $request)
    {
    	...
    	$this->type_karantina   = explode('_', $model->getTable())[1];
    }
    ...
    private function uploadProccess()
    {
        ...
        /*Jika Pada Pengecekan ditemukan data PNBP 0 Pada Dokumen pelepasan yang seharusnya dikenakan tarif PNBP -> maka throw error*/
    ...
    private function uploadProccessNihil()
    {
        ...
        $model->wilker_id   = $this->setUserWilkerId((int) $this->request->wilker_id);
        $model->user_id     = $this->checkActiveUserIdAndRequestUserId((int) $this->request->user_id);
