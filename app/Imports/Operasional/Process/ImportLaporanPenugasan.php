...
class ImportLaporanPenugasan extends ImportMaster implements ToCollection, WithMultipleSheets, WithHeadingRow
{
    /**
    ...
    private function prepareDatas(Collection $rows)
    {
    	...
    	return $rows->map(function($row) {
	        ...
	        $row['tanggal_pelepasan']  = $this->formatTanggal($row['tanggal_pelepasan']);
             ...
             $row['tgl_surat_tugas'] = $this->formatTanggal($row['tgl_surat_tugas']);
