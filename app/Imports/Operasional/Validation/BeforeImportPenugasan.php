...
use App\Contracts\Operasional\ModelPenugasanInterface as Model;

class BeforeImportPenugasan extends BeforeImport
{
    /**
     * Set awal kebutuhan property validator
     *
     * @param App\Contracts\Operasional\ModelPenugasanInterface $model
    ...
    public function runValidation() : bool
    {
        ...
        if (! $this->validateLaporanPenugasanFromIqfast()) {

            $this->setWarning("Format Laporan Yang Anda Unggah Bukan Merupakan Format Laporan Penugasan Dari IQFAST!");
        ...
        if (! $this->validateMustLaporanBulanan()) {
            ...
            $this->setWarning("Hanya Laporan Penugasan Bulanan Yang Boleh Diupload!");
