...
class PembatalanDokKh extends Model implements ModelPembatalanInterface
{
     ...
     */
    public function scopeGetJumlahPembatalanKhDokumen($query, array $arguments)
    {
     ...
     * @return Illuminate\Support\Collections
     */
    public function scopeGetJumlahPembatalanPerWilkerKhDokumen($query, array $arguments)
    {
