...
return [
    ...
    'url' => [
        'user-management' =>  env('APP_USER_API_URL') . (env('APP_ENV') == 'local' ? '/public' : '') .'/api/login/e-office',
        'e-ipnbk' =>  env('APP_IPNBK_API_URL') . (env('APP_ENV') == 'local' ? '/public' : '') .'/api/login/e-office'
    ]
];
