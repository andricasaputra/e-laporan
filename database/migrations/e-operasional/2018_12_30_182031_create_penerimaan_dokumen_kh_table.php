...
class CreatePenerimaanDokumenKhTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('penerimaan_dokumen_kh', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('penerimaan_dokumen_kh');
    }
}
