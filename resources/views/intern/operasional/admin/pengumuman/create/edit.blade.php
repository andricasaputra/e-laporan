...
<div class="d-flex align-items-center">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page"><a href="{{ route('admin.pengumuman.index') }}"></a>Pengumuman</li>
  ...
  <div class="col-md-12 col-sm-12">
    ...
    <div class="card text-center">
      <div class="card-body">
        ...
        <form action="{{ route('admin.pengumuman.update', $pengumuman->id) }}" method="post" class="form-loader">
            ...
            <div class="form-group">
              ...
              <div class="float-left" style="width: 95%;">
                <textarea name="konten[]" class="form-control" required rows="5">
                  {{ $pengumuman->konten }}
                </textarea>
              </div>
    ...
    <div class="col">
      <div class="text-center">
        <a href="{{ route('admin.pengumuman.index') }}" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Kembali</a>
      </div>
    </div>
  </div>  
