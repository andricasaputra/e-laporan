...
@section('title', 'Menu Data Operasional KH')
...
<h4 class="page-title">Menu Data Operasional Karantina Hewan</h4>
<div class="d-flex align-items-center">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('show.operasional') }}">Home</a></li>
            <li class="breadcrumb-item" aria-current="page"><a href="{{ route('showmenu.operasional.kh') }}"> Menu </a></li>
  ...
  <div class="col-md-4 col-sm-12">
    <div class="card text-center">
      ...
      <div class="card-footer bg-transparent">
        <a href="{{ route('show.rekapitulasi.operasional.kh') }}" class="btn btn-primary">Detail</a>
      </div>
    </div>
  </div>  
  <div class="col-md-4 col-sm-12">
    <div class="card text-center">
      ...
      <div class="card-footer bg-transparent">
        <a href="{{ route('show.statistik.operasional.kh') }}" class="btn btn-primary">Detail</a>
      </div>
    </div>
  </div> 
  <div class="col-md-4 col-sm-12">
