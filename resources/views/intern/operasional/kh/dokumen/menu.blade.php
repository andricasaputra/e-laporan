  ...
  <div class="col-md-4 col-sm-12">
    <div class="card text-center">
      ...
      <div class="card-footer bg-transparent">
        <a href="{{ route('kh.dokumen.data') }}" class="btn btn-default">Masuk</a>
      </div>
    </div>
  </div>
  <div class="col-md-4 col-sm-12">
    <div class="card text-center">
      ...
      <div class="card-footer bg-transparent">
        <a href="{{ route('kh.dokumen.penerimaan.create') }}" class="btn btn-default">Masuk</a>
      </div>
    </div>
  </div> 
  <div class="col-md-4 col-sm-12">
...
<script>
  ...
  $(document).ready(function(){
    ...
    logPenerimaan(
      '#penerimaan', '{{ route('api.kh.dokumen.penerimaan') }}/' + year + '/' + month + '/' + wilker
    );
