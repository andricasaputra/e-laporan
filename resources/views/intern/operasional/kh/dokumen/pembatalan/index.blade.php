...
<h4 class="page-title">Detail Operasional Pembatalan Dokumen Karantina Hewan</h4>
    ...
    <div class="row">
      <div class="col-md-12 card">
          ...
          <div class="card-header">
            Data Pembatalan Dokumen Karantina Hewan Tahun <span id="yearSelect">{{ $tahun }}</span>
          </div>
          <div class="card-body">
