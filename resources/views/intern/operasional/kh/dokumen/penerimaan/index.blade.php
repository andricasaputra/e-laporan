...
<h4 class="page-title">Detail Operasional Permintaan Dokumen Karantina Hewan</h4>
      ...
      <div class="col-md-6">
        <div class="card">
          <div class="card-header">
            Data Permintaan Dokumen Karantina Hewan Tahun <span id="yearSelect">{{ $tahun }}</span>
          </div>
