...
<div class="modal fade" id="laporanRekapitulalsiKomoditiDownloadModal" tabindex="-1" role="dialog" aria-labelledby="laporanOperasionalDownloadModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<form action="{{ route('kh.download.rekapitulasi') }}" method="POST">
			<div class="modal-content">
				
				<div class="modal-header">
					<h5 class="modal-title" id="laporanOperasionalDownloadModalLabel">Download Laporan Rekapitulasi Komoditi</h5>
