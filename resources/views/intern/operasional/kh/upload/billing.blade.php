...
<h4 class="page-title">Upload Laporan Billing Karantina Hewan</h4>
...
<div class="row">
  <div class="col-md-6 offset-md-2 col-sm-12">
    ...
    <div class="card text-center">
      <div class="card-body">
        <h4>Upload Billing Karantina Hewan</h4>
        <form action="{{ route('kh.upload.proses.report_billing') }}" method="post" enctype="multipart/form-data" class="form-loader">
            @csrf
