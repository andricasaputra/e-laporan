...
<h4 class="page-title">Upload Data Operasional Pembatalan Dokumen Karantina Hewan</h4>
...
<div class="row">
  <div class="col-md-6 offset-md-2 col-sm-12">
    ...
    <div class="card text-center">
      <div class="card-body">
        <h4>Upload Pembatalan Dokumen Karantina Hewan</h4>
        <form action="{{ route('kh.upload.proses.pembatalan_dokumen') }}" method="post" enctype="multipart/form-data" class="form-loader">
            @csrf

            <input type="hidden" name="user_id" value="{{ $user->id }}">

            <input type="hidden" name="jenis_permohonan" value="Pembatalan Dokumen kh">
