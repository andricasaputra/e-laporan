...
<h4 class="page-title">Upload Data Operasional Reekspor Karantina Hewan</h4>
...
<div class="row">
  <div class="col-md-6 offset-md-2 col-sm-12">
    ...
    <div class="card text-center">
      <div class="card-body">
        <h4>Upload Reekspor Karantina Hewan</h4>
        <form action="{{ route('kh.upload.proses.reekspor') }}" method="post" enctype="multipart/form-data" class="form-loader">
            @csrf
