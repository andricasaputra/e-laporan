...
<h4 class="page-title">Upload Data Operasional Serah Terima Karantina Hewan</h4>
...
<div class="row">
  <div class="col-md-6 offset-md-2 col-sm-12">
    ...
    <div class="card text-center">
      <div class="card-body">
        <h4>Upload Serah Terima Karantina Hewan</h4>
        <form action="{{ route('kh.upload.proses.serah_terima') }}" method="post" enctype="multipart/form-data" class="form-loader">
            @csrf
