  ...
  <script>
    $(document).ready(function() {
      ...
      datatablesOperasional(
        container, 
        '{{ route('api.kt.detail.frekuensi.impor', [$tahun, $bulan, $userWilker === 1 ? null : $userWilker]) }}', 
        'kt'
      );
      ...
      $('#change_data').on('submit', function(e){
        ...
        if (year != '' && month == '' && wilker == '') {
          ...
          datatablesOperasional(container, 
            '{{ route('api.kt.detail.frekuensi.impor') }}/' + year, 
          'kt');

        } else if(year != '' && month != '' && wilker == '') {

          datatablesOperasional(container, 
            '{{ route('api.kt.detail.frekuensi.impor') }}/' + year + '/' + month, 
          'kt');

        } else {

          datatablesOperasional(container, 
            '{{ route('api.kt.detail.frekuensi.impor') }}/' + year + '/' + month + '/' + wilker, 
          'kt');
