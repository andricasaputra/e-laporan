...
@section('title', 'Data Dokumen Operasional KT')
...
<div class="d-flex align-items-center">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page"><a href="{{ route('kt.dokumen.index') }}">Dokumen</a></li>
        ...
        <table class="table table-responsive table-striped table-bordered text-center w-100 d-block d-md-table table-ringkasan">
          ...
          <tbody>
            ...
            @forelse($datas['pembatalan'] as $data)
              ...
              <tr>
<<<<<<< HEAD
                <td>{{ $data->wilker->getOriginal('nama_wilker') }}</td>
=======
...
<script>
  ...
  $(document).ready(function(){
    ...
    $('#change_data').on('submit', function(e){
      ...
      window.location = '{{ route('kt.dokumen.data') }}/' + year + '/' + month + '/' + wilker;
