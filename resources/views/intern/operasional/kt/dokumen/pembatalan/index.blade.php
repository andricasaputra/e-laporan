...
@section('title','Operasional - Data Pembatalan Dokumen')
...
<h4 class="page-title">Detail Operasional Pembatalan Dokumen Karantina Tumbuhan</h4>
<div class="d-flex align-items-center">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Detail Pembatalan Dokumen</li>
        </ol>
    </nav>
</div>
    ...
    <div class="row">
      <div class="col-md-12 card">
          ...
          <div class="card-header">
            Data Pembatalan Dokumen Karantina Tumbuhan Tahun <span id="yearSelect">{{ $tahun }}</span>
          </div>
          <div class="card-body">
