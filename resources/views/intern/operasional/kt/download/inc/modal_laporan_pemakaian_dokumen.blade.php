...
<div class="modal fade" id="laporanPemakaianDokumenModal" tabindex="-1" role="dialog" aria-labelledby="laporanOperasionalDownloadModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<form action="{{ route('kt.download.pemakaian_dokumen') }}" method="POST">
			<div class="modal-content">
				
				<div class="modal-header">
					<h5 class="modal-title" id="laporanOperasionalDownloadModalLabel">Download Laporan Penerimaan Dan Pemakaian Dokumen</h5>
				...
				<div class="modal-body">
					...
					<input type="hidden" name="jenisLaporan" value="laporan_pemakaian_dokumen">
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									<input type="number" name="scale" class="form-control" value="100">
								</div>
							</div>
						</div>
