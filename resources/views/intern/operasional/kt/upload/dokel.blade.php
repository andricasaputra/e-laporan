...
@section('title', 'Upload Laporan Dokel')
...
<h4 class="page-title">Upload Data Operasional Domestik Keluar Karantina Tumbuhan</h4>
  ...
  <div class="col-md-6 offset-md-2 col-sm-12">
    ...
    <div class="card text-center">
      <div class="card-body">
        ...
        <form action="{{ route('kt.upload.proses.dokel') }}" method="post" enctype="multipart/form-data" class="form-loader">
            @csrf
