...
<h4 class="page-title">Upload Data Operasional Pembatalan Dokumen Karantina Tumbuhan</h4>
<div class="d-flex align-items-center">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">Pembatalan Dokumen</li>
        </ol>
    </nav>
</div>
...
<div class="row">
  <div class="col-md-6 offset-md-2 col-sm-12">
    ...
    <div class="card text-center">
      <div class="card-body">
        <h4>Upload Pembatalan Dokumen Karantina Tumbuhan</h4>
        <form action="{{ route('kt.upload.proses.pembatalan_dokumen') }}" method="post" enctype="multipart/form-data" class="form-loader">
            @csrf

            <input type="hidden" name="user_id" value="{{ $user->id }}">

            <input type="hidden" name="jenis_permohonan" value="Pembatalan Dokumen KT">
