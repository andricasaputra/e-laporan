...
@section('title', 'Upload Laporan Penugasan Domas')
...
<h4 class="page-title">Upload Penugasan Domestik Masuk Karantina Tumbuhan</h4>
...
<div class="row">
  <div class="col-md-6 offset-md-2 col-sm-12">
    ...
    <div class="card text-center">
      <div class="card-body">
        <h4>Upload Penugasan Domestik Masuk Karantina Tumbuhan</h4>
        <form action="{{ route('kt.upload.proses.domas') }}" method="post" enctype="multipart/form-data" class="form-loader">
            @csrf

            <input type="hidden" name="user_id" value="{{ $user->id }}">

            <input type="hidden" name="jenis_permohonan" value="Penugasan Domestik Masuk">
